...
def next_date_for_year_april():
    ...
    annual_data_april = data['annual_data_jan']
    # print(half_data_jan)
    print(annual_data_april)
    # Initialize an empty list to store the results
    results = []    
    for item in annual_data_april:
        ...
        month = 12 # Loop through all quater
